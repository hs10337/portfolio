...
const colorGroups: { label: string; note: string; swatches: Swatch[] }[] = [
  {
    ...
    swatches: [
      { name: "Cream 50", varName: "--color-cream-50", hex: "#f9fafb", utility: "bg-cream-50" },
      { name: "Cream 100", varName: "--color-cream-100", hex: "#eff1f3", utility: "bg-cream-100" },
      { name: "Shell 100", varName: "--color-shell-100", hex: "#e3e6ea", utility: "bg-shell-100" },
    ],
  },
  {
    label: "Pink & Lavender",
    ...
    swatches: [
      { name: "Pink 50", varName: "--color-pink-50", hex: "#ece4e6", utility: "bg-pink-50" },
      { name: "Pink 100", varName: "--color-pink-100", hex: "#d4c5ca", utility: "bg-pink-100" },
      { name: "Lavender 50", varName: "--color-lavender-50", hex: "#e4e4ec", utility: "bg-lavender-50" },
      { name: "Lavender 100", varName: "--color-lavender-100", hex: "#cbcbdc", utility: "bg-lavender-100" },
    ],
  },
  {
    label: "Ink",
    ...
    swatches: [
      { name: "Ink 900", varName: "--color-ink-900", hex: "#16181a", utility: "bg-ink-900", onDark: true },
      { name: "Ink 700", varName: "--color-ink-700", hex: "#2f3236", utility: "bg-ink-700", onDark: true },
      { name: "Ink 500", varName: "--color-ink-500", hex: "#61656b", utility: "bg-ink-500", onDark: true },
      { name: "Ink 300", varName: "--color-ink-300", hex: "#afb2b6", utility: "bg-ink-300" },
      { name: "Ink 100", varName: "--color-ink-100", hex: "#dee0e3", utility: "bg-ink-100" },
    ],
  },
  {
    label: "Ember",
